    ...
    <td align="center">
        ...
        <!-- Блок номер 1 -->
         <span style="display:inline-block; width:600px;">
             <b>Аккаунт №{{ $user_id }} активирован на сайте 21market.ru!</b>
         </span>
        <!-- Блок номер 1 -->
 <!--[if gte mso 9]>
 </td></tr></table>
...
<table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0; background:#ffffff;" width="100%">
  <tr>
    <td align="center>
        ...
        <!-- Блок номер 1 -->
         <span style="display:inline-block; width:600px;">
             <p>Поздравляем! Теперь Вы можете заказывать товары на портале <strong>21market.ru</strong></p>
              <hr>
              <p>Для авторизации в дальнейшем используйте в качестве логина адрес электронной почты <b>{{ $email }}</b> или номер телефона и пароль <b>{{ $password }}</b>.</p>
